...
SECRET_KEY = 'django-insecure-&riy%l9w+e*%@dzi@q76g^5zjh1d++54arx=-_3shcb39m05of'

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv("PRODUCTION", False)
DEBUG = not PRODUCTION

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "arief-ridzki-mentalhealthtracker.pbp.cs.ui.ac.id", "10.0.2.2"]
